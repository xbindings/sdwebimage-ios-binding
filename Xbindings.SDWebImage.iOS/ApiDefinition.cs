...
{
    partial interface ISDWebImageCoder {}
    partial interface ISDWebImageDownloaderOperationInterface {}
    partial interface ISDWebImageOperation {}
    partial interface ISDWebImageProgressiveCoder {}
    ...
    interface NSData_ImageContentType
    {
        ...
        // +(CFStringRef _Nonnull)sd_UTTypeFromSDImageFormat:(SDImageFormat)format;
        [Static]
        [Export("sd_UTTypeFromSDImageFormat:")]
        unsafe NSString Sd_UTTypeFromSDImageFormat(SDImageFormat format);
    }
    ...
    [Static]
    partial interface SDWebImageCoderConstants
    {
        ...
        NSString ScaleDownLargeImagesKey { get; }
    }
    ...
    interface SDWebImageCoder
    {
        ...
        [return: NullAllowed]
        UIImage DecompressedImageWithImage([NullAllowed] UIImage image, [NullAllowed] out NSData data, [NullAllowed] NSDictionary optionsDict);
    ...
    interface SDWebImageCodersManager : SDWebImageCoder
    {
        ...
        SDWebImageCoder[] Coders { get; set; }
    ...
    delegate NSDictionary SDWebImageDownloaderHeadersFilterBlock([NullAllowed] NSUrl arg0, [NullAllowed] NSDictionary arg1);
    ...
    [Static]
    partial interface SDWebImageDownloaderOperationInterfaceConstants
    {
        // extern NSString *const _Nonnull SDWebImageDownloadStartNotification;
        [Field("SDWebImageDownloadStartNotification", "__Internal")]
        NSString StartNotification { get; }
        ...
        NSString ReceiveResponseNotification { get; }
        ...
        NSString FinishNotification { get; }
    }
    ...
    interface UIImage_MultiFormat
    {
        ...
        void Sd_imageLoopCount(nuint value);

        [Export("getSd_imageLoopCount")]
        nuint GetSd_imageLoopCount();
    ...
    [Static]
    partial interface SDWebImageInternalConstants
    {
        ...
        NSString SetImageInGlobalQueueKey { get; }
    }
